...
public class PieGraph extends View {
    ...
    private int thickness = getResources().getInteger(R.integer.stats_circle_thickness);
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawText(text, (getWidth() / 2) - (bounds.width() / 2), (getHeight() / 2) - ((paint.descent() + paint.ascent()) / 2), paint);
    ...
    public void addData(int amount, int total){
        this.amount = amount;
        this.total = total;
    }
