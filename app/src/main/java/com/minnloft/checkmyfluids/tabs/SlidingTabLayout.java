...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    //Change this to change the tab text font size
     ...
     */
    public void setCustomTabView(int layoutResId, int textViewId, int textViewImage) {
        mTabViewLayoutId = layoutResId;
        mTabViewTextViewId = textViewId;
        mTabViewImageId = textViewImage;
    }
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        //Change tab titles to be all caps or not.
